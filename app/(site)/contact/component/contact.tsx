...
const Contact = ({ data }: { data: NonNullable<ContactQueryResult> }) => {
  return (
    <section className="max-width-container padding-container flex flex-col gap-5 bg-white md:gap-11">
      <div className="mx-auto flex max-w-[870px] flex-col gap-3 md:gap-2">
        <div className="text-center text-2xl font-semibold text-black md:text-[40px]">
          {data.formTitle}
        </div>
      </div>
      <div className="mt-8 grid grid-cols-1 gap-16 md:mt-16 md:grid-cols-2 md:gap-8 xl:grid-cols-3">
        ...
        <div className="order-1 col-span-1 md:order-2">
          <div className="flex flex-col gap-3">
            <p className="text-ebony text-lg font-medium">{data.getInTouchHeading}</p>
            <p className="text-ebony text-base font-normal">{data.getInTouchDescription}</p>
          </div>
          <div className="mt-10 flex flex-col gap-3">
            <p className="text-ebony text-lg font-medium">{data.locationInfoTitle}</p>
            <iframe
              ...
              loading="lazy"
            />
            <p className="text-ebony mt-1 text-base font-normal md:text-lg">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <Link
              ...
              className="text-secondary-blue flex w-fit items-center gap-2 text-base font-semibold"
            >
              <svg
              ...
              >
                <path
                  d="M2.50033 4.16671L8.97709 9.20419C9.57894 9.6723 10.4217 9.6723 11.0236 9.20419L17.5003 4.16671M4.33366 16.6667H15.667C16.6004 16.6667 17.0671 16.6667 17.4236 16.4851C17.7372 16.3253 17.9922 16.0703 18.152 15.7567C18.3337 15.4002 18.3337 14.9335 18.3337 14V6.00004C18.3337 5.06662 18.3337 4.59991 18.152 4.24339C17.9922 3.92979 17.7372 3.67482 17.4236 3.51503C17.0671 3.33337 16.6004 3.33337 15.667 3.33337H4.33366C3.40024 3.33337 2.93353 3.33337 2.57701 3.51503C2.2634 3.67482 2.00844 3.92979 1.84865 4.24339C1.66699 4.59991 1.66699 5.06662 1.66699 6.00004V14C1.66699 14.9335 1.66699 15.4002 1.84865 15.7567C2.00844 16.0703 2.2634 16.3253 2.57701 16.4851C2.93353 16.6667 3.40024 16.6667 4.33366 16.6667Z"
                  stroke="#074187"
                  strokeWidth="1.67"
                />
              </svg>
